...
const checkRole = useSessionStore().checkRole
    ...
    <Layout :judul="`Bidang ${tipe}`">
        <div class="p-6 bg-white grid grid-cols-1 md:grid-cols-2 gap-24">
            <div class="space-y-8">
                ...
                <template v-if="checkRole(['admin', 'kadiv'])">
                    <Button color="secondary" data-modal-target="staticModal"
                        data-modal-toggle="staticModal">Edit</Button>
